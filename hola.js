...
// }
// Ejercicio 11
var valoresUno = [2, 3, 7, 15, 24, 56];
var valoresDos = [3, 4, 5, 6, 4, 3, 18, 3, 4, 5, 5, 6, 6, 7];
var vectorFusionado = valoresUno.concat(valoresDos);
for (var index = 0; index < vectorFusionado.length; index++) {
